export function Loader(props: any) {
  return (
    <svg className={props.className ? props.className : "inline-block w-5 h-5 textMuted " } version="1.1" id="L7" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100">
